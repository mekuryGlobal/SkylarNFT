...
{
    [SerializeField]
    private string contract = "0x60f80121c31a0d46b5279700f9df786054aa5ee5";
    [SerializeField]
    private string Account = "0xCBd5521e2b9E6FcED940E8201D189B69e6E77814";
    [SerializeField]
    ...
    async public void SafeTransferFrom()
    {
        ...
        string[] obj = { Account, PlayerPrefs.GetString("Account"), tokenId };
